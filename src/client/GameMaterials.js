...
const threeMaterialConfigDefaults = { color: 0xffffff, blending:THREE.CustomBlending};
const materials = {
  ...
  [MATERIAL_TYPE_ROCK]: {
    ...
    density: 1600,
    dynamic: true,
    three: new THREE.MeshPhongMaterial({...threeMaterialConfigDefaults, shininess:10}),
  ...
  [MATERIAL_TYPE_DIRT]: {
    ...
    density: 1225,
    dynamic: true,
    three: new THREE.MeshPhongMaterial({...threeMaterialConfigDefaults, shininess:0}),
  ...
  [MATERIAL_TYPE_MOSS]: {
    ...
    density: 1300,
    dynamic: true,
    three: new THREE.MeshPhongMaterial({...threeMaterialConfigDefaults, shininess:20}),
    cannon: new CANNON.Material(MATERIAL_TYPE_MOSS, {friction:0.9, restitution:0.15}),
  }
};
